...
import requests
#realiza solicitudes a la API de Geocoding para obtener información de todas las paradas
if __name__ == '__main__':
    ...
    with open ("./data/todas_las_solicitudes2.txt", "w",encoding="utf-8") as f:   
        for estacion in lista_estaciones:
            url = "https://maps.googleapis.com/maps/api/place/textsearch/json"
            params = {
                "query": f"Metro {estacion}, Ciudad de México, CDMX, México",
                "type": "subway_station",  
                "key": API_KEY
            }
    ...
    with open("./data/estaciones_metro2.json", "w",encoding="utf-8") as f:
