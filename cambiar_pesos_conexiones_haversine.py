...
#Cálculo de distancia entre dos coordenadas utilizando fórmula de Haversine
...
#Heurística = distancia aérea + (mínimoTrasbordos * 1080 (trasbordo más corto))
...
if __name__ == '__main__':
    ...
    with open("./data/230Conexiones_v5.txt", "w", encoding="utf-8") as f:
